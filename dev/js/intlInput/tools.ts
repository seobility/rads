...
export const intlTel = (
    input: HTMLInputElement,
    settings: IntlTelSettings = {}
) => {
    const initedInstance = getIntlTelInstance(input)
...
class IntlTel {
    ...
    init() {
        ...
        setIntlTelInstance(this.input, this)
...
export const getIntlTelInstance = (input: HTMLInputElement) => {
    return IntlInstances.get(input)
}

export const setIntlTelInstance = (input: HTMLInputElement, instance: IntlTel) => {
